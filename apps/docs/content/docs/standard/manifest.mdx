...
### `thresholds`
Per-repo overrides for the standard's numeric thresholds. Use this to tune rules to your repo's reality instead of forking the standard — for example, a repo with legitimately large generated-adjacent files can raise the C2 line limit:
