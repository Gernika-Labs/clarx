...
Four rules can produce a hard failure. Each active hard failure caps the overall score using a graduated floor (one → max 65, two → 50, three → 35, four or more → 25). See [Scoring Model](/docs/standard/scoring#hard-failures) for details.
