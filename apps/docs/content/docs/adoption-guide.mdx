...
description: Three ways to adopt intention/ui, with or without replacing your current design system.
---

intention/ui is designed to be adopted in layers. You do not have to replace your current component library to benefit from it.
...
If your team already has a component library and cannot replace it, you can still adopt intention/ui as an extension layer:
...
Many teams will not adopt the reference components wholesale. That is fine. The most portable part of intention/ui is the thinking, not the files.
