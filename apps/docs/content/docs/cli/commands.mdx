...
Run without a rule id to print a measurement-scope overview — what Clarx
measures, what it explicitly does **not** measure (code quality, security,
correctness, test coverage), and the full rule list by pillar:
